...
Дякуємо, що користуєтеся **F5M/I2P Reseed**!
...
- [Issues на Codeberg](https://codeberg.org/f5m/i2p-reseed/issues)
- [Issues на GitHub](https://github.com/damian-buho/f5m-i2p-reseed/issues)
...
4. **Середовище** — операційна система, версія F5M/I2P Reseed, версія середовища виконання.
...
Платна підтримка для F5M/I2P Reseed доступна:
